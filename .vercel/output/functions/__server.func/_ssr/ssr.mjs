...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Cf3Muapz.mjs");
...
var manifest = { "40d98133b4c81b1a8a4ab1bed13d22449354d789f6ee3e02aea0a840b37de03e": {
	functionName: "askStarSpirit_createServerFn_handler",
	importer: () => import("./ask-Bq__RCw3.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BqNGgz6D.mjs").then((n) => n.t),
